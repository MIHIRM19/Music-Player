...
class NowPlaying : Fragment() {
    ...
    override fun onResume() {
        ...
        if (PlayerActivity.musicService != null){
            ...
            binding.songNameNP.text = PlayerActivity.musicListPA[PlayerActivity.songPosition].title
            if (PlayerActivity.isPlaying) binding.playPauseBtnNP.setIconResource(R.drawable.pause_song)
    ...
    private fun playMusic() {
        ...
        binding.playPauseBtnNP.setIconResource(R.drawable.pause_song)
        PlayerActivity.musicService!!.showNotification(R.drawable.pause_song)
        PlayerActivity.binding.nextBtnPA.setIconResource(R.drawable.pause_song)
