...
class NotificationReceiver:BroadcastReceiver() {
    ...
    private fun playMusic(){
        ...
        NowPlaying.binding.playPauseBtnNP.setIconResource(R.drawable.pause_song)
    }
    ...
    private fun prevNextSong(increment: Boolean, context: Context){
        ...
        if (PlayerActivity.isFavourite) PlayerActivity.binding.favouriteBtnPA.setImageResource(R.drawable.fav)
        else PlayerActivity.binding.favouriteBtnPA.setImageResource(R.drawable.empty_fav)
    }
}